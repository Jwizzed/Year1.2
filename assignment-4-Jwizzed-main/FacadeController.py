...
class FacadeController:
    ...
    @staticmethod
    def getInstance():
        if FacadeController.instance is None:
            FacadeController.instance = FacadeController()
    ...
    def na_function(self):
        print("Welcome to the student menu")
        student_option = self.student_menu()
        while True:
            try:
                if student_option == 1:
                    self.ask_information()
        ...
        while True:
            try:
                if student_option == 1:
                    ...
                    self.ask_information()
                    self.update_student(self.name, self.idNumber, self.contactNumber)
                    print("student updated")

                elif student_option == 4:
                    self.ask_information()
                    self.find_student(self.name, self.idNumber, self.contactNumber)
