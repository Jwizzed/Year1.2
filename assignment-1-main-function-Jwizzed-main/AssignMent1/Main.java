...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			record.setIdNumber(12345678);
			record.setContactNumber("0212312322");
		...
		do {
			...
			switch (option) {
				...
				case 1:
					...
					try {
						record = new Student(name, idNumber, contactNumber);
						hr.add(record);
				...
				case 4:
					...
					for (Student people : hr.getStudentList()) {
						if (people.getIdNumber() == (bookId)) {
